...
When we construct the biological manifestations for decision-making operators may be the structural motifs we may want to search for when we consider the expanse of the neural circuits in the human brain.

While this depiction may not be completely generalizable to a brain in its complexity, analyzing the simplest model may present us with an easier model we can use to dissect the true circuits.
...
loopNetworkv1 <- data.frame(srcLOOPv1, targetLOOPv1) # construct data frame with source and target vectors
