...
instructions <- function() {
  ...
  print(
    "This project is essentially a pipeline which allows for fluid force-directed network construction."
  )
  print("To create MicroNetworks, use the following lines as syntax examples:")
  print(
    "AND(n,n): create an AND MicroNetwork with any number of input neurons n and any output neurons n."
  )
...
constructLinearMicroNetwork <- function() {
  ...
  while (editMode == TRUE) {
    selectedNet <-
      readline(prompt = "Name the MicroNetwork you would like to add: ")
    ...
    continue <-
      readline(prompt = "Would you like to add a new MicroNetwork? (Y/N) ")
